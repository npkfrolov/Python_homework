...
semi_major_axis_min = 5729137  # это значение взято как равное малой полуоси +1 (избегаем деления на 0)
semi_major_axis_max = 7161973  # это значение взято как равное малой полуоси +1 (избегаем деления на 0)
semi_minor_axis_min = 5729752  # это значение округленно соответствует длине градуса широты в 100 км
